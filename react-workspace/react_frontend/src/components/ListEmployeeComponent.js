  ...
  render() {
    return (
      <div className='class'>
            ...
            <div className='row'>       
            <Link to="/add-employee" className='btn btn-outline-success mt-4 w-100'>Add Employee</Link>    
          
                <table className='table  table-striped table-bordered' style={{padding:"50px"}}>
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>FirstName</th>
